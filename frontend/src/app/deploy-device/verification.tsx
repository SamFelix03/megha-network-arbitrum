                    ...
                    >
                        ...
                        <div className="p-3 rounded-lg bg-franky-blue-10 border border-franky-blue-30 mb-4">
                            <div className="flex items-center mb-1">
                                ...
                                <span className="text-franky-blue text-sm font-medium font-sen">Wallet Status</span>
                            ...
                            <div className="text-xs text-gray-400 ml-8">
                                <p className="flex justify-between">
                                    ...
                                    <span className="text-franky-blue font-sen">
                        ...
                        <div className="p-4 rounded-lg bg-franky-blue-10 border border-franky-blue-30 mb-4">
                            <label htmlFor="hostingFee" className="block text-franky-blue text-sm font-medium mb-2 font-sen">
                                API Fee (USDC)
                            </label>
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full p-3 text-lg font-medium rounded-lg bg-black/50 border border-franky-blue-30 text-white focus:outline-none focus:border-franky-blue transition-colors font-sen"
                                    placeholder="Enter amount"
                                    autoFocus
                                />
                                <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                    <span className="text-franky-blue font-sen">USDC</span>
                                </div>
                            </div>
                            ...
                            <details className="group rounded-lg bg-black/50 border border-franky-blue-20 overflow-hidden">
                                ...
                                <div className="p-2 pt-0 text-xs space-y-1">
                                    <div className="flex justify-between py-1 border-t border-franky-blue-20">
                                        ...
                                        <span className="text-franky-blue font-sen">{deviceDetails.deviceModel}</span>
                                    </div>
                                    <div className="flex justify-between py-1 border-t border-franky-blue-20">
                                        <span className="text-gray-400 font-sen">RAM</span>
                                        <span className="text-franky-blue font-sen">{deviceDetails.ram}</span>
                                    </div>
                                    <div className="flex justify-between py-1 border-t border-franky-blue-20">
                                        <span className="text-gray-400 font-sen">Storage</span>
                                        <span className="text-franky-blue font-sen">{deviceDetails.storageCapacity}</span>
                                    </div>
                                    <div className="flex justify-between py-1 border-t border-franky-blue-20">
                                        <span className="text-gray-400 font-sen">CPU</span>
                                        <span className="text-franky-blue font-sen">{deviceDetails.cpu}</span>
                                    </div>
                                    <div className="flex justify-between py-1 border-t border-franky-blue-20">
                                        <span className="text-gray-400 font-sen">OS</span>
                                        <span className="text-franky-blue font-sen">{deviceDetails.os}</span>
                                    </div>
                                </div>
                            </details>
                            ...
                            <details className="group rounded-lg bg-black/50 border border-franky-blue-20 overflow-hidden">
                                ...
                                <div className="p-2 pt-0 text-xs space-y-1">
                                    <div className="flex justify-between py-1 border-t border-franky-blue-20">
                                        ...
                                        <span className="text-franky-blue text-xs break-all font-sen">{deviceDetails.walletAddress.toLowerCase().substring(0, 8)}...{deviceDetails.walletAddress.toLowerCase().substring(deviceDetails.walletAddress.toLowerCase().length - 8)}</span>
                                    </div>
                                    <div className="flex justify-between py-1 border-t border-franky-blue-20">
                        ...
                        {transactionHash && transactionHash.length > 0 ? (
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                className="p-3 rounded-lg bg-franky-blue-10 border border-franky-blue-30 text-center"
                            >
                                <FiCheck className="text-franky-blue mx-auto text-xl mb-1" />
                                <p className="text-franky-blue font-medium text-sm font-sen">Device verification successful!</p>

                                {deviceDetails && (
                                    <div className="mt-2 text-sm text-franky-blue">
                                ...
                                <div className="mt-2 text-xs text-franky-blue">
                                    ...
                                    <a
                                        ...
                                        className="text-franky-blue underline hover:text-white text-xs mt-1 inline-block font-sen"
                                    >
                                        View
                                    </a>
                                </div>
